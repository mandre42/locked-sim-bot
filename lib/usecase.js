...
module.exports = {
  ...
  getReply: (db, entities, conversations, userId) => new Promise(resolve => {
    console.log(entities.puk, 10000000 <= parseInt(entities.puk.value, 10), parseInt(entities.puk.value, 10) <= 99999999)
    if (entities.puk && 10000000 <= parseInt(entities.puk.value, 10) && parseInt(entities.puk.value, 10) <= 99999999) {
      if (entities.puk.value.toString()[0] % 2 == 0) {
